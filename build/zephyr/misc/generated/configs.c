...
GEN_ABSOLUTE_SYM(CONFIG_CLOCK_CONTROL_NRF_IRQ_PRIORITY, 1);
GEN_ABSOLUTE_SYM(CONFIG_CLOCK_CONTROL_NRF_M16SRC_DRV_NAME, 1);
GEN_ABSOLUTE_SYM(CONFIG_CLOCK_CONTROL_NRF_K32SRC_DRV_NAME, 1);
